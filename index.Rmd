...
oc <- st_read("data/OC Properties 2023.shp")
...
m <- leaflet() %>%
 ...
 m <- m %>%
    addCircleMarkers(data = cams_1, color = "blue", group = "camera trap", weight=3,opacity=0.3, radius=1, popup="cameratraps")  %>%
    addCircleMarkers(data = kids, color = "yellow", group = "kids club", weight=3,opacity=1, radius=1, popup="kids clubs")   %>%
    addCircleMarkers(data = road, color = "purple", group = "road survey", weight=3,opacity=1, radius=1, popup="road survey")   %>%
    addCircleMarkers(data = rest, color = "orange", group = "restoration", weight=3,opacity=1, radius=1, popup="restoration")   
